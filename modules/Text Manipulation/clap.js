module.exports = {
	...
	execute: async function(client, message, args) {
		...
		return clappedEnd.length < 2000 ? message.channel.sendMessage(clappedEnd) : message.channel.sendMessage('Hey, can you chill? Keep the length of the message a bit shorter.');
	},
};
