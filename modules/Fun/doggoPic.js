...
module.exports = {
	...
	execute: async function(client, message, args) {
		...
		const msg = await message.channel.sendMessage({ embeds: [dogEmbed] });
		...
		return message.channel.sendMessage({ embeds: [new MessageEmbed().setDescription('So uh the API doesn\'t wanna talk rn').setColor(tofuError)] });
	},
};
